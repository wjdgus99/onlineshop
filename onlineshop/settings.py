...
SECRET_KEY = 'django-insecure-#qz!5%be9+1z37=gipbcnx)l$lco(a@^^z+cm98fsluzyco!k%'
...
DATABASES = {
    'default': {
        ...
        'USER': 'admin',
        'PASSWORD': '12345678',
        'HOST': 'onlinemarket.cins1powgtgn.ap-northeast-2.rds.amazonaws.com',
        'PORT': '3306',
    }
}
...
AWS_STORAGE_BUCKET_NAME = 'django-onlinemarket'
